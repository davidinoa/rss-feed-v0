...
export const meta: ComponentMeta = {
  ...
  props: {
    ...
    type: {
      ...
      default: "'button'",
      description:
        "Native button type. Pass 'submit' for form submit buttons.",
    },
    className: {
      type: "string",
      required: false,
  ...
  variants: {
    axes: {
      variant: ["default", "secondary", "ghost", "destructive", "outline", "link"] as const,
  ...
  tokens: {
    ...
    color: {
      ...
      "ring-offset-background": "Focus ring offset against the page background.",
  ...
  aiHints: {
    ...
    selectionCriteria: {
      ...
      "secondary action paired with primary (cancel, dismiss)": "variant: 'secondary'",
      ...
      "icon-only action (theme toggle, mark-as-read)": "variant: 'ghost', size: 'icon'",
